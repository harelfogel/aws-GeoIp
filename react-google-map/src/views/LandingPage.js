...
Geocode.setApiKey("AIzaSyDNbMjULLIYPx95ki_JckxXeqStivqYoYc");
Geocode.enableDebug();
    ...
    render() {
        ...
        return (
            <div style={{ padding: '1rem', margin: '0 auto', maxWidth: 1000 }}>
                ...
                <AsyncMap
                    googleMapURL="https://maps.googleapis.com/maps/api/js?key=AIzaSyDNbMjULLIYPx95ki_JckxXeqStivqYoYc&libraries=places"
                    loadingElement={
